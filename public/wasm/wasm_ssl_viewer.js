 ...
 */
export function parse_certificate(cert_der) {
...
const CertificateInfoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_certificateinfo_free(ptr >>> 0, 1));
...
export class CertificateInfo {
    ...
    get valid_from() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.certificateinfo_valid_from(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get valid_to() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.certificateinfo_valid_to(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get serial_number() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.certificateinfo_serial_number(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get version() {
        const ret = wasm.certificateinfo_version(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_ssl_viewer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
